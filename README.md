...
```json
"dependencies": {
    "@whiskeysockets/baileys": "npm:@dark-yasiya/baileys"
}
```
or install in terminal:
```
npm install @whiskeysockets/baileys@npm:@dark-yasiya/baileys
```
...
## Reporting Issues
If you encounter any issues while using this repository or any part of it, please feel free to open a [new issue](https://github.com/DarkYasiyaNew/Baileys/issues) here.
